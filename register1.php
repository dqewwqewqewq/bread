...
$name = $address = $salary614 = $username = $password ="";
$name_err = $address_err = $salary614_err = $username_err =$password_err ="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // Validate salary614
    $input_salary614 = trim($_POST["salary614"]);
    if(empty($input_salary614)){
        $salary614_err = "Please enter the salary614 amount.";     
    } elseif(!ctype_digit($input_salary614)){
        $salary614_err = "Please enter a positive integer value.";
    } else{
        $salary614 = $input_salary614;
    }
...
if(empty(trim($_POST["password"]))){
    ...
    if(empty($name_err) && empty($address_err) && empty($salary614_err)&& empty($username_err)&& empty($password_err)){
        // Prepare an insert statement
        $sql = "INSERT INTO employees (name, address, salary614, username, password) VALUES (?, ?, ?, ?, ?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssiss", $param_name, $param_address, $param_salary614, $param_username, $param_password);
            
            // Set parameters
            $param_name = $name;
            $param_address = $address;
            $param_salary614 = $salary614;
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div id="header-wrapper">
		...
		<nav class="nav">
			<div class="container">
			  <h1 class="logo"><a href="/index.html">Luca’s Loaves<img src="3.png "width：10px；height：10px  /></a></h1>
			  <ul>
				...
				<li><a href="aboutus.html" accesskey="2" title="">About US</a></li>
				  ...
				  <li><a href="register1.php" class="current"accesskey="6" title="">Register</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"id="form"syley="align=“center”">
                        ...
                        <div class="form-group">
                            <label>salary</label>
                            <input type="text" style="width:500px;height:50px"name="salary614" class="form-control <?php echo (!empty($salary614_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $salary614; ?>">
                            <span class="invalid-feedback"><?php echo $salary614_err;?></span>
                        </div>
                        <div class="form-group">
...
/
	...
	<div class="footer">
	@Copyright-Marco,Xiang Enyu 614. 